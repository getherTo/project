...
function formatSay($say, $created_at, $user_name)
{

  return '<div class="saylist"><img src="images/default.png" width="60" height="60" class="img-circle"/>
	<div class="saytxt">
	<p><strong>'.$user_name.'</strong><br>'. nl2br($say).'
	</p><div class="date">发表时间 '.$created_at.'</div>
	</div>
	<div class="clear"></div>
	</div>';
}
