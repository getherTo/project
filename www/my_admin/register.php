	...
	<div class="loginwarrp">
        ...
        <li class="login-item">
          ...
          <input type="password" name="password2" class="login_input" required="required">
                ...
                <a href="javascript:;" title="点击图片切换验证码"><img src="code/SecurityCoder.php" id="img_code" border="0" class="verifyimg" /></a>
            ...
            <script>
                ...
                $("#img_code").click( function(){
                    ...
                    $("#img_code").attr("src", "code/SecurityCoder.php?v=" + Math.random() )
                })
            </script>
		</div>
	</div>
