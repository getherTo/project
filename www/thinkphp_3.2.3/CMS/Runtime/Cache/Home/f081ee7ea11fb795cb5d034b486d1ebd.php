...
<div id="dcWrap">
    ...
    <ul>
        ...
        <li class="cur"><a href="<?php echo U('index/show');?>"><i class="show"></i><em>首页幻灯广告</em></a></li>
    ...
    <div id="dcMain">
        ...
        <h3>首页幻灯广告</h3>
        <table width="800px" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            <tr>
                <th>添加幻灯</th>
            </tr>
            <tr>
                <td width="350" valign="top">
                    <form action="<?php echo U('index/update_banner');?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($home_imgs["id"]); ?>" />
                        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
                            <tr>
                                <td><b>幻灯名称</b>
                                    <input type="text" name="title" value="<?php echo ($home_imgs["title"]); ?>" size="20" class="inpMain" />
                                </td>
                            </tr>
                            <tr>
                                <td><b>幻灯图片</b>
                                    <input type="file" name="img" class="inpFlie"  />
                                    <img width="300px" height="200px" src="<?php echo ($home_imgs["img"]); ?>"></td>
