...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <ul>
  <li class="cur"><a href="article_category.html"><i class="articleCat"></i><em>新闻分类</em></a></li>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong> 新闻分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="add_article_category.html?rec=add" class="actionBtn add">添加分类</a> 新闻分类</h3>
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
         ...
         <?php if(is_array($news_category)): $i = 0; $__LIST__ = $news_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news_category): $mod = ($i % 2 );++$i;?><tr>
                 ...
                 <td align="center"><?php echo ($news_category["name"]); ?></td>
                 <td align="center">
                     <a href="/thinkphp_3.2.3/cms.php/home/index/edit_news/id/<?php echo ($news_category["id"]); ?>">编辑</a>&nbsp;
     ...
     <script>
         function del( id  ){
             if( confirm("您确定删除此新闻吗？") ){
                 document.location.href = "/thinkphp_3.2.3/cms.php/home/index/delete_news_category/id/" + id ;
             }
         }
         function adNews(){
             document.location.href = "/thinkphp_3.2.3/cms.php/home/index/add_article_category" ;
