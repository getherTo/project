...
<script type="text/javascript" src="/thinkphp_3.2.3/Public/cms/js/jquery.autotextarea.js"></script>
</head>
<body>
<div id="dcWrap">
 <div id="dcHead">
 <div id="head">
  <div class="logo"><a href="index.html"><img src="/thinkphp_3.2.3/Public/cms/images/dclogo.gif" alt="logo"></a></div>
  <div class="nav">
   <ul>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加新闻</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="article.html" class="actionBtn">新闻列表</a>添加新闻</h3>
    <form action="<?php echo U('index/insert_news');?>" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right">新闻名称</td>
       <td>
      ...
      <tr>
       ...
       <td>
        <!-- KindEditor -->
        <link rel="stylesheet" href="/thinkphp_3.2.3/Public/cms/js/kindeditor/themes/default/default.css" />
			<link rel="stylesheet" href="/thinkphp_3.2.3/Public/cms/js/kindeditor/plugins/code/prettify.css" />
			<script charset="utf-8" src="/thinkphp_3.2.3/Public/cms/js/kindeditor/kindeditor.js"></script>
			<script charset="utf-8" src="/thinkphp_3.2.3/Public/cms/js/kindeditor/lang/zh_CN.js"></script>
			<script charset="utf-8" src="/thinkphp_3.2.3/Public/cms/js/kindeditor/plugins/code/prettify.js"></script>
        <script>
