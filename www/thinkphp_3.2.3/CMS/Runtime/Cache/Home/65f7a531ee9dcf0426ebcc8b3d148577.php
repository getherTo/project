 ...
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    ...
    <li class="noRight"><a href="login.html?rec=logout">退出</a></li>
   </ul>
  </div>
 </div>
</div>
   ...
   <div class="indexBox">
    ...
    <ul>
     <table width="100%" border="0" cellspacing="0" cellpadding="7" class="tableBasic">
      ...
      <tr>
       <td> 系统使用协议： </td>
       <td><a href="http://www.mycodes.net/license.html" target="_blank">http://www.mycodes.net/license.html</a>
           <em>（您可以免费使用DouPHP（不限商用），但必须保留相关版权信息。）</em></td>
      </tr>
     </table>
    </ul>
   </div>
