...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li><a href="article.html"><i class="article"></i><em>新闻列表</em></a></li>
 </ul>
   <ul class="bot">
    ...
    <tr>
     ...
     <tr>
      <td width="350" valign="top">
       <form action="<?php echo U('index/add_banner');?>" method="post" enctype="multipart/form-data">
           <input type="hidden" value="">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         <tr>
          <td><b>幻灯名称</b>
<input type="text" name="title" value="" size="20" class="inpMain" />
          </td>
         </tr>
         <tr>
          <td><b>幻灯图片</b>
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        <tr>
         <td width="30">幻灯片ID</td>
         <td width="30">幻灯片名称</td>
         <td width="100" align="center">幻灯片地址</td>
         <td width="80" align="center">操作</td>
        </tr>
           <?php if(is_array($arr_home_imgs)): $i = 0; $__LIST__ = $arr_home_imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$home_imgs): $mod = ($i % 2 );++$i;?><tr>
                   <td align="center"><?php echo ($home_imgs["id"]); ?></td>
                   <td align="center"><?php echo ($home_imgs["title"]); ?></td>
                   <td align="center"><img src="<?php echo ($home_imgs["img"]); ?>" alt="" width="90px" height="70px"></td>
                   <td align="center">
                       <a href="/thinkphp_3.2.3/cms.php/home/index/edit_images?id=<?php echo ($home_imgs["id"]); ?>">编辑</a>&nbsp;
                       <a href="<?php echo U('index/delete_banner');?>?id=<?php echo ($home_imgs["id"]); ?>?id=<?php echo ($home_imgs["id"]); ?>">删除</a>
                   </td>
