...
?>
    ...
    <div style="width: 1200px;margin:10 auto">
        ...
        <table border="1px" width="1200px" align="center" class="cv">
            <tr>
                <th>
                    <a href="list.php?orderby=id&order=<?php echo $str_order;?>">id</a>
                    <?php
                    if($orderby == "id"){
                        ?>
                ...
                <th>
                    <a href="list.php?orderby=name&order=<?php echo $str_order;?>">姓名</a>
                    <?php
                    if($orderby == "name"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
                ...
                <th>
                    <a href="list.php?orderby=sex&order=<?php echo $str_order;?>">性别</a>
                    <?php
                    if($orderby == "sex"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
                ...
                <th>
                    <a href="list.php?orderby=city&order=<?php echo $str_order;?>">城市</a>
                    <?php
                    if($orderby == "city"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
                ...
                <th>
                    <a href="list.php?orderby=height&order=<?php echo $str_order;?>">身高</a>
                    <?php
                    if($orderby == "height"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
                ...
                <th>
                    <a href="list.php?orderby=weight&order=<?php echo $str_order;?>">体重</a>
                    <?php
                    if($orderby == "weight"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
                ...
                <th>
                    <a href="list.php?orderby=mobile&order=<?php echo $str_order;?>">手机号</a>
                    <?php
                    if($orderby == "mobile"){
                        ?>
                        <img src="/images/icon/png_16x16/<?php echo $order_img?>">
