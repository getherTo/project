...
$arr_femal_full_name  = array(); // 女性名字
for( $i=0;$i<$num;$i++){
    $arr_femal_full_name[] = $arr_first_name[$first_name_index[$i]] . $arr_female_name[$last_female_index[$i]];
}



// 男性名字
echo "<table width='200' align='center' border='1px'>";
echo "<tr>";
echo "<td>男性名字</td>";
echo "<td>女性名字</td>";
echo "<tr>";
echo "<td>";
echo implode("<br>", $arr_male_full_name);
echo "</td>";
echo "<td>";
echo implode("<br>", $arr_femal_full_name);
echo "</td>";
echo "</tr>";
echo "</table>";
